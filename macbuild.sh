...
echo "Tweaking Mac app specifics for this release..."
sed -i "s/vGOESHERE/v$1/g" out/mac/RoboPaint.app/Contents/Info.plist

echo "Outputting final DMG with included app file..."
echo "Creating dmg..."
dd if=/dev/zero of=out/RoboPaint-Mac-v$1.dmg bs=1M count=125 &&
echo "Formatting dmg..."
